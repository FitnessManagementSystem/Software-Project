...
@CucumberOptions(
        features = "src/test/resources/features/ClientFeatures/ClientProgramExplorationandEnrollment.feature", // Path to your feature files
...
public class ClientServiceProgramExplorationAndEnrollmentTestRunner {
